                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="information_text">
                            <ul class="p-0">
                                <li><b>Location:</b> Pune</li>
                                <li><b>Category:</b> Residential </li>
                                <li><b>Collaboration:</b> MTDI & BIAS group of Architects  </li>

                                <li><b>Status:</b> Ongoing</li>
                                <li><b>Client:</b> AjayGarg & Megha Garg</li>
                                <li><b>Area:</b> 64sqm </li>                                
                                <li><b>Material:</b> Rubber Wood </li>                                
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-8">
<!--                         <div>
               ...
               <div class="col-md-8 offset-md-2 portfolio-images top_90 text-center">
                    <figure class="bottom_30"><img src="../images/pune-lounge/0.Cover.png" alt=""></figure>
                    <figure class="bottom_30"><img src="../images/pune-lounge/1.jpg" alt=""></figure>
                    <figure class="bottom_30"><img src="../images/pune-lounge/2.1.jpg" alt=""></figure>
                    <figure class="bottom_30"><img src="../images/pune-lounge/2.jpg" alt=""></figure>
                    <figure class="bottom_30"><img src="../images/pune-lounge/3.jpg" alt=""></figure>
                    <figure class="bottom_30"><img src="../images/pune-lounge/4.jpg" alt=""></figure>
                    <figure class="bottom_30"><img src="../images/pune-lounge/6.jpg" alt=""></figure>
                    <figure class="bottom_30"><img src="../images/pune-lounge/7.jpg" alt=""></figure>
                    <figure class="bottom_30"><img src="../images/pune-lounge/9.jpg" alt=""></figure>
                    <figure class="bottom_30"><img src="../images/pune-lounge/11.jpg" alt=""></figure>
                    <figure class="bottom_30"><img src="../images/pune-lounge/15.jpg" alt=""></figure>
                    <figure class="bottom_30"><img src="../images/pune-lounge/16.1.jpg" alt=""></figure>
                    <figure class="bottom_30"><img src="../images/pune-lounge/17.1(e).png" alt=""></figure>
